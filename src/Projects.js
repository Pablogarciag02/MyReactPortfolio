...
export default function Projects() {
  return (
    <div class =" justify-center xl:inline-grid grid-cols-2 mt-10 flex-row">
        ...
        <div class = "justify-center p-4 mx-8 rounded-lg">
            <h2 class ="text-xl text-center my-8 font-semibold">Crypto Asset Manager</h2>
            <img class ="w-64 m-auto rounded-lg hover:w-96 hover:ease-in duration-300" src={process.env.PUBLIC_URL+"favicons/cryptoAssetmgr.jpg"}></img>
        ...
        <div class = "justify-center p-4 mx-8 rounded-lg">
            ...
            <img class ="w-64 hover:w-96 hover:ease-in duration-300  m-auto rounded-lg" src={process.env.PUBLIC_URL+"favicons/pinit.png"}></img>
        ...
        <div class = "justify-center p-4 mx-8 rounded-lg">
            ...
            <img class ="w-64 m-auto rounded-lg hover:w-96 hover:ease-in duration-300" src={process.env.PUBLIC_URL+"favicons/techblog.png"}></img>
        ...
        <div class = "justify-center p-4 mx-8 rounded-lg">
            ...
            <img class ="w-64 m-auto rounded-lg hover:w-96 hover:ease-in duration-300" src={process.env.PUBLIC_URL+"favicons/employeeTracker.jpeg"}></img>
        ...
        <div class = "justify-center p-4 mx-8 rounded-lg">
            ...
            <img class ="w-64 m-auto rounded-lg hover:w-96 hover:ease-in duration-300" src={process.env.PUBLIC_URL+"favicons/weatherDashboard.jpg"}></img>
        ...
        <div class = "justify-center p-4 mx-8 rounded-lg ">
            ...
            <img class ="w-64 m-auto rounded-lg hover:w-96 hover:ease-in duration-300" src={process.env.PUBLIC_URL+"favicons/codingQuiz.jpg"}></img>
        ...
        <div class = "justify-center p-4 mx-8 rounded-lg ">
            ...
            <img class ="w-64 m-auto rounded-lg hover:w-96 hover:ease-in duration-300" src={process.env.PUBLIC_URL+"favicons/workDay.jpg"}></img>
